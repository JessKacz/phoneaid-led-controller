...
class LinearLEDPreview(QWidget):
    ...
    def set_led_grid_positions(self, positions, cols=None, rows=None):
        ...
        """
        LED_GRID_POSITIONS = {
    0:(0,0),  1:(0,1),  2:(2,3),  3:(3,3),  4:(1,2),  5:(1,1),
    6:(5,3),  7:(2,1),  8:(1,0),  9:(3,2), 10:(3,1), 11:(2,0), 12:(3,0),
    13:(5,2), 14:(9,3), 15:(7,2), 16:(4,0), 17:(5,0),
    18:(5,1), 19:(6,1), 20:(8,1), 21:(6,0),
    22:(9,2), 23:(10,2), 24:(12,3), 25:(9,1),
    26:(7,0), 27:(8,0), 28:(9,0),
    29:(11,1), 30:(12,2), 31:(15,3),
    32:(13,2), 33:(13,1),
    34:(10,0), 35:(11,1), 36:(11,0),
    37:(15,1), 38:(15,2), 39:(18,3),
    40:(17,2), 41:(16,1),
    42:(12,0), 43:(13,0),
    44:(19,2), 45:(19,3)
}
